...
def send_sns(topic, msg, sub, awsid, awskey, awsregion):
    ...
    sns = boto.connect_sns(awsid, awskey, region=region)
...
if __name__ == "__main__":
    ...
    tornado.options.define("awsid", help="Amazon Web Services Access Id", default=False, type=str)
    tornado.options.define("awskey", help="Amazon Web Services Access Key", default=False, type=str)
    ...
    if tornado.options.options.awsid == "":
        logging.error("No AWS ID specified. use --awsid or look at --help for more info.")
        exit(0)
    
    if tornado.options.options.awskey == "":
        logging.error("No AWS Key specified. use --awskey or look at --help for more info.")
        exit(0)
